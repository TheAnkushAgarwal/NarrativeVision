    ...
    return (
        <footer className="text-white bg-currentcolor px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="/Narrative__1_-removebg-preview.png" className="w-32 sm:mx-auto" />
                <p className="leading-relaxed mt-2 text-[15px]">
                 NarrativeVision-An AI tool for generating videos from text that will cut down the video production time by as much as 95%.
                </p>
            </div>
